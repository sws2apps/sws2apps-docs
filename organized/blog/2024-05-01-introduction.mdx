...
> Now it's way faster and easier for me to create schedules for the whole month, to me it feels like tens times faster! It now takes me only a couple of minutes because 99% of work is automated and Organized does it good, so I can participate in ministry and congregation activities more! I do like that Organized allows me to use autofill feature, but afterwards refine it manually in some rare cases. Furthermore, I can conveniently track the participation of any brother not only for a single week but also for several months backward and forward. As a result, we now use less paper and all of the congregation info is easy to find by both publishers and responsible brothers. I totally recommend everybody to try Organized!
>
